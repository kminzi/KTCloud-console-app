...
public class APIcall_Messaging extends APIcall_main {
     ...
     **/
    public ArrayList<String[]> listSubscriptions() throws IOException, InvalidKeyException, NoSuchAlgorithmException, ParseException {
     ...
     * @brief Messaging 기능에 해당하는, 토픽 및 구독 정보 출력을 위한 함수
     **/
    public void publishMessage(String topicUrn, String subject, String message) throws IOException, InvalidKeyException, NoSuchAlgorithmException, ParseException, ParseException {
